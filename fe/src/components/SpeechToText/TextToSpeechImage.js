...
var SpeechRecognitionEvent = window.SpeechRecognitionEvent || window.webkitSpeechRecognitionEvent;
    ...
    function setGameStates(){
        ...
        var testicle = 3;
        ///api stuff
        const apiCall = "https://retro-pokemon-game-api-k6cgale4bq-uc.a.run.app/pokemon/"+testicle
     
        const input = document.querySelector(".name");
        console.log(input);

        const imageName = "snorlax";
        const soundName = "snorlax";
    ...
    function game (){
        ...
        setTimeout(() => { document.getElementById('audio').play(); }, 1500);
    ...
    return(
        ...
        <div id="sprite-black" className='sprite-black'>
            <img className="blackout" src={pokeSprite} width="px" height="350px" alt="filter applied" />
        </div>
        <div id="sprite-revealed" className='sprite-revealed'>
            <img className="revealed" src={pokeSprite} width="px" height="350px" alt="filter applied" />
        </div>
            <div className="d-flex flex-column h-100 p-15 pr-10 text-white text-shadow-1"></div>
            </div></div>
